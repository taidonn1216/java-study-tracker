...
class TrackerControllerTest {
    ...
    void testIndex() throws Exception {
        ...
        when(trackerService.getOverdueTasksForCurrentUser(eq("testuser"), any())).thenReturn(Collections.emptyList());
    ...
    void testCreateTask() throws Exception {
        ...
        verify(trackerService, times(1)).createTask(1L, "問題集1-10ページ", TaskStatus.IN_PROGRESS,
                LocalDate.parse("2026-02-27"), "頑張る");
    }
    ...
    void testCreateTask_DeadlineBlank() throws Exception {
        ...
        verify(trackerService, never()).createTask(anyLong(), anyString(), any(TaskStatus.class), any(), anyString());
    }
    ...
    void testCreateTask_OtherUsersSubject() throws Exception {
        ...
        verify(trackerService, never()).createTask(anyLong(), anyString(), any(), any(), anyString());
        verify(trackerService, times(1)).getSubjectForCurrentUser(99L, 1L);
    }
}
