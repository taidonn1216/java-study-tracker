...
INSERT INTO TASK (subject_id, title, completed,status,deadline,reflection) VALUES (1, '第3章: コレクションフレームワーク', false,'進行中','2026-02-26','記入してください');
...
INSERT INTO TASK (subject_id, title, completed,status,deadline,reflection) VALUES (2, 'JOINの種類を学習する', false,'進行中','2026-02-26','記入してください');
INSERT INTO TASK (subject_id, title, completed,status,deadline,reflection) VALUES (2, 'トランザクション処理を理解する', false,'進行中','2026-02-26','記入してください');
...
INSERT INTO TASK (subject_id, title, completed,status,deadline,reflection) VALUES (3, 'DIコンテナの仕組みを学ぶ', false,'進行中','2026-02-26','記入してください');
INSERT INTO TASK (subject_id, title, completed,status,deadline,reflection) VALUES (3, 'Spring JDBCを実装する', false,'進行中','2026-02-26','記入してください');
